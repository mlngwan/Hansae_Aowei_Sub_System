...
#if (defined KS_CODE)
#error KS_CODE already defined
#endif
#define KS_CODE

#if (defined KS_CONST)
#error KS_CONST already defined
#endif
#define KS_CONST

#if (defined KS_APPL_DATA)
#error KS_APPL_DATA already defined
#endif
#define KS_APPL_DATA

#if (defined KS_APPL_CONST)
#error KS_APPL_CONST already defined
#endif
#define KS_APPL_CONST

#if (defined KS_APPL_CODE)
#error KS_APPL_CODE already defined
#endif
#define KS_APPL_CODE

#if (defined KS_VAR_NOINIT)
#error KS_VAR_NOINIT already defined
#endif
#define KS_VAR_NOINIT

#if (defined KS_VAR_POWER_ON_INIT)
#error KS_VAR_POWER_ON_INIT already defined
#endif
#define KS_VAR_POWER_ON_INIT

#if (defined KS_VAR_FAST)
#error KS_VAR_FAST already defined
#endif
#define KS_VAR_FAST

#if (defined KS_VAR)
#error KS_VAR already defined
#endif
#define KS_VAR
...
#if (defined SWAPSF_CODE)
#error SWAPSF_CODE already defined
#endif
#define SWAPSF_CODE

#if (defined SWAPSF_CONST)
#error SWAPSF_CONST already defined
#endif
#define SWAPSF_CONST

#if (defined SWAPSF_APPL_DATA)
#error SWAPSF_APPL_DATA already defined
#endif
#define SWAPSF_APPL_DATA

#if (defined SWAPSF_APPL_CONST)
#error SWAPSF_APPL_CONST already defined
#endif
#define SWAPSF_APPL_CONST

#if (defined SWAPSF_APPL_CODE)
#error SWAPSF_APPL_CODE already defined
#endif
#define SWAPSF_APPL_CODE

#if (defined SWAPSF_VAR_NOINIT)
#error SWAPSF_VAR_NOINIT already defined
#endif
#define SWAPSF_VAR_NOINIT

#if (defined SWAPSF_VAR_POWER_ON_INIT)
#error SWAPSF_VAR_POWER_ON_INIT already defined
#endif
#define SWAPSF_VAR_POWER_ON_INIT

#if (defined SWAPSF_VAR_FAST)
#error SWAPSF_VAR_FAST already defined
#endif
#define SWAPSF_VAR_FAST

#if (defined SWAPSF_VAR)
#error SWAPSF_VAR already defined
#endif
#define SWAPSF_VAR
