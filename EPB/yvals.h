 ...
 */
 ...
 #elif defined(__rce) || defined(__rce__)
#ifdef __LITTLE_ENDIAN__
  #define _D0		3
#else
  #define _D0		0	/* 0: big endian, 3: little endian floating-point */
  ...
  #define _LBIAS	0x3fe	/* 64 long double bits */
  #define _LOFF		4	/* 64 long double bits */
  #define _FPP_TYPE	_FPP_PPC	/* Use PowerPC FPP */
...
typedef unsigned int _Sizet;
  ...
  #if _HAS_C9X && defined(__EDG__) && !defined(__cplusplus)
...
/* #define _STD_USING	define C names in one of three namespaces */
  ...
  #else /* __CYGWIN__ */
  /* FIXME: Simplify this bit, since we do not define _NO_MT, the default will work */
   #if defined(_NO_WINDRIVER_MODIFICATIONS)	
    #ifndef _NO_MT
...
#define _HAS_TR1_DECLARATIONS	1	/* always enabled if retained */
 ...
 #if defined(__STDC_WANT_SAFER_LIB__)
...
#define _ILONG		1	/* 0 if 16-bit int */
 ...
 #else
  #if defined(__ppc) || defined(__rce) || defined(__arm) || defined(__s390__) || defined(__CHAR_UNSIGNED__) || defined(_CHAR_UNSIGNED)
   #define _CSIGN		0	/* 0 if char is not signed */
  #else
...
typedef wint_t _Wintt;
 ...
 #elif defined(_WIN32_C_LIB) || defined(__RTP__) || defined(__DCC__)
  #define _WCMIN	0
  #define _WCMAX	0xffff
...
typedef va_list _Va_list;
 ...
 #if defined(__EDG__) && !defined(__x86_64)
  #undef va_copy
 #endif /* __EDG__ */
