...
/**
 * @file    xpc560bc.h
 * @brief   register set of SPC560BCxx microcontroller.
 */ 
...
#if 0
//1 Added start by Gabriel
				union {                 /* User Nonvolatile Private Censorship Password Register 0-1 */
            vuint32_t R;
            struct {
                vuint32_t PWD:32;
            } B;
				...
				union {                 /* Nonvolatile System Censorship Control register 0-1 */
            vuint32_t R;
            struct {
                vuint32_t SW:16;
								vuint32_t CW:16;
				...
				union {                 /* Nonvolatile User Options register */
            vuint32_t R;
            struct {
								vuint32_t WATCHDOG_EN:1;
								vuint32_t OSCILLATOR_MARGIN:1;
								vuint32_t PAD3V5V:1;
                vuint32_t :29;
            } B;
        }NVUSRO;
//1 Added end by Gabriel
#endif
    };                          /* end of CFLASH_tag */
/****************************************************************************/
/*                          MODULE : CGM                                   */
/****************************************************************************/
    ...
    /************************************/
        ...
        } CMU_HFREFR_A;         /* High Frequency Reference Register PLL_A 
Register */
        ...
        } CMU_LFREFR_A;         /* Low Frequency Reference Register PLL_A 
Register */
...
/****************************************************************************/
    struct DSPI_tag {
        ...
        } RSER;                 /* DMA/Interrupt Request Select and Enable 
Register */
...
*/
        ...
        union {
            vuint32_t R;
        } MUDCR;                /* ECSM Miscellaneous User-Defined Control 
Register */
...
/****************************************************************************/
        ...
        uint32_t FLEXCAN_reserved3[256];        /* {0x0880-0x0480}/0x4 = 
0x100 */
...
/****************************************************************************/
    ...
    struct LINFLEX_tag {
        ...
        } LINTCSR;              /* LINFLEX LIN Time-Out Control Status 
Register */
        ...
        } BDRL;                 /* LINFLEX Buffer Data Register Least 
Significant */
        ...
        } BDRM;                 /* LINFLEX Buffer Data Register Most 
Significant */
        ...
        } IFMI;                 /* LINFLEX Identifier Filter Match Index 
Register */
        ...
        } IFCR[16];             /* LINFLEX Identifier Filter Control Register 
0-15 */
...
/****************************************************************************/
    struct MPU_tag {
        ...
        } RGDAAC[16];           /* Region Descriptor Alternate Access Control 
n */
...
/****************************************************************************/
    struct SIU_tag {
        ...
        union {                 /* Interrupt Rising-Edge Event Enable 
Register */
            vuint32_t R;
            struct {
                vuint32_t:16;
        ...
        union {                 /* Interrupt Falling-Edge Event Enable 
Register */
            vuint32_t R;
            struct {
                vuint32_t:16;
        ...
        union {                 /* Pad Selection for Multiplexed Input 
Register */
            vuint8_t R;
            struct {
                vuint8_t:4;
...
/****************************************************************************/
    struct WKUP_tag {
        ...
        } WIREER;               /* Wakeup/Interrupt Rising-Edge Event Enable 
Register */
        ...
        } WIFEER;               /* Wakeup/Interrupt Falling-Edge Event Enable 
Register */
